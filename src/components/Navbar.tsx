        ...
        <>
            <nav>
                <header className="fixed inset-x-0 top-0 z-[99] bg-[#ecf6ff] dark:bg-background">
                    <div className="container mx-auto flex items-start justify-between pt-[32px] pb-4">
                        {/* Logo */}
                        ...
                        <div className="flex flex-col justify-start gap-[3px]">
                            {["My projects", "About me", "Writings", "Photos&Artworks"].map((item, idx) => (
                                <div key={idx} className="font-bold text-[#56adcb] text-base">
                                    {item}
                                </div>
                            ))}
                        </div>
                        ...
                        {/* Menu droit */}
                        <div className="flex flex-col justify-start w-[100px] gap-[3px]">
                        ...
                        <button
                            ...
                            rounded-[42px] border-2 border-[#56adcb] h-[36px] px-4 gap-x-[10px]
